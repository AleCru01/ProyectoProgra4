...
int fila = tblVuelos.getSelectedRow();
    ...
    if (fila >= 0) {
        ...
        int idVuelo = Integer.parseInt(tblVuelos.getValueAt(fila, 0).toString());
        int idO = Integer.parseInt(tblVuelos.getValueAt(fila, 1).toString());
        int idD = Integer.parseInt(tblVuelos.getValueAt(fila, 2).toString());
      
        String nomOrigen = tblVuelos.getValueAt(fila, 3).toString(); 
        String nomDestino = tblVuelos.getValueAt(fila, 4).toString();
        
  
        String numV = tblVuelos.getValueAt(fila, 5).toString();
        String hSal = tblVuelos.getValueAt(fila, 6).toString();
        String hLleg = tblVuelos.getValueAt(fila, 7).toString();
        String fec = tblVuelos.getValueAt(fila, 8).toString();
        String est = tblVuelos.getValueAt(fila, 9).toString();
        int cap = Integer.parseInt(tblVuelos.getValueAt(fila, 10).toString());
        double prec = Double.parseDouble(tblVuelos.getValueAt(fila, 11).toString());
    ...
    int fila = tblVuelos.getSelectedRow();
        if (fila >= 0) {
            int id = (int) tblVuelos.getValueAt(fila, 0);
