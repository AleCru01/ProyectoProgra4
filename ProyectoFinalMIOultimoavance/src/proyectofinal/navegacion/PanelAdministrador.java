...
import proyectofinal.AltaUsuariosAdmin;
    ...
    private void initComponents() {
        ...
        txtUsuarios4 = new javax.swing.JLabel();
        ...
        btnAggUsuarios1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnAggUsuarios1MouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnAggUsuarios1MouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnAggUsuarios1MouseExited(evt);
            }
        });

        txtUsuarios4.setFont(new java.awt.Font("Corbel Light", 0, 24)); // NOI18N
        txtUsuarios4.setForeground(new java.awt.Color(255, 255, 255));
        txtUsuarios4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        txtUsuarios4.setText("Alta Usuarios");

        javax.swing.GroupLayout btnAggUsuarios1Layout = new javax.swing.GroupLayout(btnAggUsuarios1);
        btnAggUsuarios1.setLayout(btnAggUsuarios1Layout);
        btnAggUsuarios1Layout.setHorizontalGroup(
            btnAggUsuarios1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(btnAggUsuarios1Layout.createSequentialGroup()
                .addGap(16, 16, 16)
                .addComponent(txtUsuarios4, javax.swing.GroupLayout.PREFERRED_SIZE, 135, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(17, Short.MAX_VALUE))
        );
        btnAggUsuarios1Layout.setVerticalGroup(
            btnAggUsuarios1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(btnAggUsuarios1Layout.createSequentialGroup()
                .addGap(20, 20, 20)
                .addComponent(txtUsuarios4)
    ...
    private void btnAggUsuarios1MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAggUsuarios1MouseEntered
        btnAggUsuarios1.setBackground(Color.decode("#AC35F2"));
    }//GEN-LAST:event_btnAggUsuarios1MouseEntered

    private void btnAggUsuarios1MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAggUsuarios1MouseExited
        btnAggUsuarios1.setBackground(Color.decode("#7524A5"));
    }//GEN-LAST:event_btnAggUsuarios1MouseExited

    private void btnAggUsuarios1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAggUsuarios1MouseClicked

        AltaUsuariosAdmin ventanaAlta = new AltaUsuariosAdmin();
