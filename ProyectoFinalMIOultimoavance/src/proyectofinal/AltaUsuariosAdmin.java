 ...
 * @author victo
 */
public class AltaUsuariosAdmin extends javax.swing.JFrame  {

public AltaUsuariosAdmin() {
    initComponents();
...
private void ajustarLogo() {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 0, 140, 110));

        jLabelFechaNac1.setFont(new java.awt.Font("Leelawadee", 1, 18)); // NOI18N
        jLabelFechaNac1.setForeground(new java.awt.Color(129, 39, 189));
    ...
    String nombre = txtNombre.getText().trim();
        ...
        try (Connection conn = ConexionBD.getConnection();
            ...
            if (filas > 0) {
                JOptionPane.showMessageDialog(this, "Usuario registrado exitosamente en el sistema.");
                this.dispose();
            } else {
